<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Jacie Thoo</h1>
      <div class="py-2">
        <h1
      ...
      <br>
      <a href="/files/Jacie_Thoo_Resume.pdf" download
...
export default {
  ...
  data() {
    return {
      toRotate: ["Immersive Media Student", "Aspriring Designer", "Passionate Learner", "Team Player"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
